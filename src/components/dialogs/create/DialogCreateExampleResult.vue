...
async function createSubmit() {
    try {
        $q.loading.show()
        const newExampleResult = extend(true, {}, selectedStore.exampleResult) as ExampleResultType
        await exampleResultsService.add(newExampleResult)
        log.info('Example created', newExampleResult)
    } catch (error) {
